...
router.put("/test-upload", upload.single("profilePic"), (req, res) => {
  res.json({
    body: req.body,
    file: req.file,
  });
...
router.get(
  "/dashboard/partners/pending-min-rate",
  verifyToken,
  isAdmin,
  getPendingMinRatePartners,
);
...
router.put(
  "/dashboard/partners/:id/documents",
  verifyToken,
  isAdmin,
  updatePartnerDocumentStatus,
);
router.put(
  "/dashboard/partners/:id/deactivate",
  verifyToken,
  isAdmin,
  deactivatePartner,
);
router.put(
  "/dashboard/partners/:id/activate",
  verifyToken,
  isAdmin,
  activatePartner,
);
...
router.put(
  "/dashboard/partners/:id/profile-approval",
  verifyToken,
  isAdmin,
  approvePartnerProfile,
);
router.put(
  "/dashboard/partners/:id/min-rate-approval",
  verifyToken,
  isAdmin,
  approveMinRateUpdate,
);
